...
export function Navbar() {
  return (
    <nav className="bg-current  border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
      <div className="container  flex flex-wrap justify-between items-center mx-auto">
        <Link href={"/"}>
          <a className="flex items-center">
            <img
              src="https://i.pinimg.com/736x/a7/58/2b/a7582bdfbe9a2df48d5660ac61592a30--manuel-san-antonio.jpg"
